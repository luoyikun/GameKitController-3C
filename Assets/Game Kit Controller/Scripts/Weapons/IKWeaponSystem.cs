...
public class IKWeaponSystem : weaponObjectInfo
{
        ...
        if (currentlyUsingSway &&
            ...
            if (!isUsingDualWeapon () || !isThirdPersonView || isFullBodyAwarenessActive) {
                ...
                if (usingPositionSway) {
                    ...
                    mainWeaponMeshTransform.localPosition = Vector3.Lerp (mainWeaponMeshTransform.localPosition, swayPosition, currentTime * currentSwayPositionSmooth);
                }
                ...
                if (usingRotationSway) {
                    ...
                    mainWeaponMeshTransform.localRotation = Quaternion.Lerp (mainWeaponMeshTransform.localRotation, swayTargetRotation, currentTime * currentSwayRotationSmooth);
                }
            } else {
    ...
    IEnumerator enableOrDisableIKOnWeaponsDuringActionCoroutine (bool state)
    {
        ...
        if (state) {
            ...
            //thirdPersonWeaponInfo.drawWeaponMovementSpeed;
            ...
            while (!targetReached) {
                ...
                if ((distanceDifference < 0.001f && angleDifference < 0.03f) || movementTimer > (duration + 1)) {
                    targetReached = true;
                }
