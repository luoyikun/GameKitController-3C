...
public class hoverBoardWayPointsEditor : Editor
{
	...
	SerializedProperty allowMovementOnBothDirections;
	...
	void OnEnable ()
	{
		...
		allowMovementOnBothDirections = serializedObject.FindProperty ("allowMovementOnBothDirections");
	...
	public override void OnInspectorGUI ()
	{
		...
		EditorGUILayout.PropertyField (allowMovementOnBothDirections);
