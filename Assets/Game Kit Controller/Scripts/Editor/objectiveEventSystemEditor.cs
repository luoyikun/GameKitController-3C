...
public class objectiveEventSystemEditor : Editor
{
	...
	SerializedProperty missionCanBeCancelledEnabled;
	...
	SerializedProperty saveOnEachSubObjectiveComplete;
	...
	SerializedProperty cancelMissionIfPlayerDiesEnabled;
	...
	void OnEnable ()
	{
		...
		missionCanBeCancelledEnabled = serializedObject.FindProperty ("missionCanBeCancelledEnabled");
        ...
        saveOnEachSubObjectiveComplete = serializedObject.FindProperty ("saveOnEachSubObjectiveComplete");
        ...
        cancelMissionIfPlayerDiesEnabled = serializedObject.FindProperty ("cancelMissionIfPlayerDiesEnabled");
	...
	public override void OnInspectorGUI ()
	{
        ...
        EditorGUILayout.PropertyField (cancelMissionIfPlayerDiesEnabled);
        ...
        EditorGUILayout.PropertyField (saveOnEachSubObjectiveComplete);
		...
		GUILayout.BeginVertical ("Other Components", "window");
