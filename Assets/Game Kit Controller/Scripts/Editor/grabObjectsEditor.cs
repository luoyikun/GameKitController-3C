...
public class grabObjectsEditor : Editor
{
	...
	SerializedProperty dropCurrentObjectOnDeathEnabled;
	SerializedProperty keepMeleeWeaponOnDeathEnabled;

	SerializedProperty headTrackBodyWeightOnAim;

	SerializedProperty customAimReticleName;

	SerializedProperty mainHeadTrack;

	SerializedProperty ignoreThrowAnimationForPhysicalObjects;

	SerializedProperty ignoreThrowAnimationForMeleePhysicalObjects;
	...
	void OnEnable ()
	{
		...
		dropCurrentObjectOnDeathEnabled = serializedObject.FindProperty ("dropCurrentObjectOnDeathEnabled");
		keepMeleeWeaponOnDeathEnabled = serializedObject.FindProperty ("keepMeleeWeaponOnDeathEnabled");

		headTrackBodyWeightOnAim = serializedObject.FindProperty ("headTrackBodyWeightOnAim");
		...
		ignoreThrowAnimationForPhysicalObjects = serializedObject.FindProperty ("ignoreThrowAnimationForPhysicalObjects");

		ignoreThrowAnimationForMeleePhysicalObjects = serializedObject.FindProperty ("ignoreThrowAnimationForMeleePhysicalObjects");
	...
	public override void OnInspectorGUI ()
	{
		...
		if (showAllSettings.boolValue || showOtherSettings.boolValue) {
			...
			GUILayout.BeginVertical ("Drop Objects On Death Settings", "window");
			EditorGUILayout.PropertyField (dropCurrentObjectOnDeathEnabled);
			EditorGUILayout.PropertyField (keepMeleeWeaponOnDeathEnabled);
			GUILayout.EndVertical ();
			...
			EditorGUILayout.PropertyField (headTrackBodyWeightOnAim);	
			EditorGUILayout.PropertyField (customAimReticleName);		
		 
			EditorGUILayout.Space ();

			EditorGUILayout.PropertyField (ignoreThrowAnimationForPhysicalObjects);	
			EditorGUILayout.PropertyField (ignoreThrowAnimationForMeleePhysicalObjects);		
