...
public class vehicleController : MonoBehaviour
{
        ...
        if (forceVehicleRotationTo2_5dViewDirection) {
            ...
            if (rawAxisValues.x == 1) {
                if (!rotatingVehicleIn2_5dToRight) {
                    float lastVelocity = mainRigidbody.velocity.magnitude;
                    ...
                    if (keepVelocityOnChangeOfDirectionOn2_5dView) {
                        mainRigidbody.velocity = lastVelocity * transform.forward;
                    }
            ...
            if (update2_5dRotationLeftOrRightEnabled) {
                ...
                if (rawAxisValues.x == 1) {
                    if (!rotatingVehicleIn2_5dToRight) {
                        ...
                        if (keepVelocityOnChangeOfDirectionOn2_5dView) {
                            mainRigidbody.velocity = lastVelocity * currentLockedCameraTransform.right;
                        }
                    }
    ...
    public bool isMovingBackwards ()
    {
        ...
        if (isTurnedOn) {
            Vector3 speedDirection = mainRigidbody.velocity;
